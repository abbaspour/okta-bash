...
curl -s -X GET -H "Accept: application/json" -H "Content-Type: application/json" -H "Authorization: SSWS ${api_token}" \
 "https://${yourOktaDomain}/api/v1/idps/credentials/keys/${idpId}" | jq .