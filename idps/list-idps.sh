...
function usage() {
  cat <<END >&2
USAGE: $0 [-e env] [-d domain] [-D preview] [-a api_token] [-v|-h]
...
curl -s -X GET -H "Accept: application/json" -H "Content-Type: application/json" -H "Authorization: SSWS ${api_token}" "https://${yourOktaDomain}/api/v1/idps"